'''
this script is AlexNet model for Keras
...
def AlexNet_model(input_shape, classes):
    '''
    ...
    x = Conv2D(96, (11, 11), strides=(4, 4), padding='valid', activation='relu',
...
if __name__ == '__main__':
    # AlexNet(input_shape=(227, 227, 3), classes=1000)
    AlexNet_model(input_shape=(227, 227, 3), classes=1000)
